...
export const DEFAULT_KEYMAP: Readonly<Record<string, string>> = {
  ...
  "mod+c": "edit.copy", "mod+x": "edit.cut", "mod+v": "edit.paste",
  "mod+d": "select.none",
  // слои и трансформация
  "mod+e": "layer.merge", "mod+g": "layer.group", "mod+a": "selection.layer",
  "mod+n": "layer.add", "mod+t": "transform.enter",
  // файл
