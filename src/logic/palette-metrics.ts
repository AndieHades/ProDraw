// Общие метрики палитры: тип цвета, ключи дедупликации и цветностное
// расстояние. Отдельный модуль, потому что ими пользуется выборка палитры
// из сэмплов и из готового RGBA-буфера.
