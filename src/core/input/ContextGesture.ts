// Жесты вызова контекстного меню: длинное нажатие, двойной тап и правая
// кнопка. Это чтение указателя, а не представление, поэтому модуль живёт в
// `core` и доступен системам напрямую.
