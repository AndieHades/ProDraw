...
import type { RgbColor } from "../logic/color.ts";
import { hexToRgb } from "../logic/color.ts";

export const DEFAULT_PALETTE_HEX: readonly string[] = [
...
export const GRAYSCALE_PALETTE_HEX: readonly string[] =
  ["#ffffff", "#d9d9d9", "#9a9a9a", "#646464", "#2f2f2f", "#000000"];

export const defaultPalette = (): RgbColor[] => DEFAULT_PALETTE_HEX.map(hexToRgb);
export const grayscalePalette = (): RgbColor[] => GRAYSCALE_PALETTE_HEX.map(hexToRgb);
