...
import {
  DEFAULT_GRAIN, DEFAULT_PREVIEW, DEFAULT_PROPERTIES, DEFAULT_RENDERING,
  DEFAULT_SHAPE, DEFAULT_TAPER
} from "./brushDefaults";
...
function preset(fileName: string, sourceUrl: string, profile: Profile): BrushPreset {
  ...
  return { format: "prodraw-brush", version: 1, revision: 1,
    ...
    taper: { ...DEFAULT_TAPER },
    shape: { ...DEFAULT_SHAPE, hardness, scatter },
    grain: { ...DEFAULT_GRAIN, strength: texture },
    rendering: { ...DEFAULT_RENDERING, flow },
