...
export const C = { bg: '#0d0d10', doc: '#141419', edge: 'rgba(255,255,255,.28)', grid: 'rgba(255,255,255,.05)', accent: '#3d8bfd', fg: '#fff',
  tileGrid: '#ff9f43', checkA: '#26262c', checkB: '#1d1d23', prevBg: '#101014', hint: '#9a9aa3' };
const KEYS = { bg: '--cv-bg', doc: '--cv-doc', edge: '--cv-edge', grid: '--cv-grid', accent: '--accent', fg: '--cv-fg',
