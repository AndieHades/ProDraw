...
- Current stage: `R1 — TypeScript and Windows foundation`
- Status: `ready`
- Last completed stage: `R0`
- Next action: add strict TypeScript/Vitest/architecture validation without changing the legacy entrypoint
- Blockers: none
- Working paths: none after the R0 planning commit
- Last checks: docs, governed lines, targeted ESLint and diff check passed
- Last updated: `2026-08-16, main@df2b924`
...
| `BRH-02`, `STB-01`, `DOC-01` performance | `R3` | deterministic recorded-trace tests and tablet stroke smoke |
...
4. The current stage chapter
5. [`90-verification.md`](90-verification.md)
...
| `R1` | [`20-stage-typescript-desktop.md`](20-stage-typescript-desktop.md) | `R0` | ready | `build: establish TypeScript desktop foundation` |
| `R2` | [`30-stage-raster-cutover.md`](30-stage-raster-cutover.md) | `R1` | planned | `feat: cut over to raster painting core` |
