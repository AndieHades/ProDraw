...
Вне очереди больших стадий завершён ограниченный
...
Bottom-first PSD-дескрипторы восстановлены, а multi-file export теперь bounded;
PNG-дерево и фильтрация viewport также закрыты. Этот repair не
