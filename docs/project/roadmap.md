...
базовые команды слоёв на того же владельца. Активен `C2D`, который завершает
перенос document/session/persistence; вместе эти этапы переводят render/history,
