...
При переходе в галерею или закрытии приложения view возвращается к центру и
вписывается в экран. Вход в Crop завершает активный Transform и выключает Move.
