...
assert.ok(document.getElementById('cropbar').classList.contains('fw-win'), 'crop panel is draggable');
assert.ok(document.getElementById('selbar').classList.contains('fw-win'), 'selection panel is draggable');
