...
import { adjustColor } from '../src/logic/adjustment.ts';
import { monochromeColor, monochromeRgba } from '../src/logic/monochrome.ts';
import { generateTints, generateShades, generateHarmonyBaseColors, generateTintShadeScalesForHarmony } from '../src/logic/tint-shade.ts';
...
import { recognizeShape } from '../src/logic/quickshape.ts';
...
import { SIZE_PRESETS, DEFAULT_DOC } from '../src/config/presets.ts';
import { defaultPalette, DEFAULT_PALETTE_HEX, DEFAULT_ACTIVE } from '../src/config/palette.ts';
