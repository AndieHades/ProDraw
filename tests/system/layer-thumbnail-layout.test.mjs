...
describe('layer thumbnail layout', () => {
  it('fills the square height for tall content and preserves proportions', () => {
  ...
  it('fills the square width for wide content and preserves proportions', () => {
    const wide = thumbnailDrawBox({ minx: 2, miny: 3, maxx: 41, maxy: 12 });
    expect(wide).toMatchObject({ sx: 2, sy: 3, sw: 40, sh: 10,
      dx: 0, dy: 15, dw: 40, dh: 10 });
